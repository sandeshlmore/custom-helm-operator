...
import (
	...
	"github.com/custom-helm-operator/internal/helm/controller"
	"github.com/custom-helm-operator/internal/helm/flags"
	"github.com/custom-helm-operator/internal/helm/metrics"
	"github.com/custom-helm-operator/internal/helm/release"
	"github.com/custom-helm-operator/internal/helm/watches"
	"github.com/custom-helm-operator/internal/util/k8sutil"
)
...
func NewCmd() *cobra.Command {
	...
	opts := &zapf.Options{TimeEncoder: zapcore.TimeEncoderOfLayout(time.RFC3339)}
